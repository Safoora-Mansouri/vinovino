...
<body class="bg-gray-200">
    <div class="relative h-screen flex flex-col justify-end">
        ...
        <div class="max-w-3xl mx-auto mb-16 bg-white bg-opacity-60 rounded-lg shadow-md p-8 relative w-full  lg:max-w-md lg:w-5/6 lg:mb-36 lg:mt-auto  lg:px-8 lg:py-1 z-10" style="width: calc(100% - 20%); height:50%;">
